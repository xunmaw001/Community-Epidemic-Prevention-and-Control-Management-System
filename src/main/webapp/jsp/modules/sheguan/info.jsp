            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">社管员登记</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <!-- 本表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="sheguanName" name="sheguanName" class="form-control"
                                               v-model="ruleForm.sheguanName" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="sheguanPhone" name="sheguanPhone" class="form-control"
                                               v-model="ruleForm.sheguanPhone" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="sheguanIdNumber" name="sheguanIdNumber" class="form-control"
                                               v-model="ruleForm.sheguanIdNumber" readonly>
                                    </div>

                                <div class="form-group col-md-6">
                                    <label>用户头像</label>
                                    <img id="sheguanPhotoImg" width="100" height="100">
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="sheguanEmail" name="sheguanEmail" class="form-control"
                                               v-model="ruleForm.sheguanEmail" readonly>
                                    </div>
