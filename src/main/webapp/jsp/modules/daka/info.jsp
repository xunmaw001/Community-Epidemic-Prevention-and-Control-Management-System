            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">隔离信息管理登记</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <input id="yonghuId" name="yonghuId" v-model="ruleForm.yonghuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="dakaName" name="dakaName" class="form-control"
                                               v-model="ruleForm.dakaName" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="dakaWendu" name="dakaWendu" class="form-control"
                                               v-model="ruleForm.dakaWendu" readonly>
                                    </div>


                                    <div class="form-group col-md-6">
                                        <label>备注</label>
                                        <input style="width: 450px" id="dakaText" name="dakaText" class="form-control"
                                               v-model="ruleForm.dakaText" readonly>
                                    </div>
...
<script>
    ...
    function setDownloadBtn() {
        var dakaFileUrl = "download('" + ruleForm.dakaFile + "')";
        $("#dakaFile").attr("onclick", dakaFileUrl);
