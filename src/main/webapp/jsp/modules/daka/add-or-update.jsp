    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑隔离信息管理</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑隔离信息管理</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">隔离信息管理信息</h3>
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="yonghuId" name="yonghuId" type="hidden">
                                    <div class="form-group col-md-6 dakaNameDiv">
                                        <label>健康码打卡</label>
                                        <input style="width: 450px" id="dakaName" name="dakaName" class="form-control"
                                               placeholder="健康码打卡">
                                    </div>
                                    <div class="form-group col-md-6 dakaFileDiv">
                                        <label>健康码照片</label>
                                        <input name="file" type="file" class="form-control-file" id="dakaFileupload">
                                        <label id="dakaFileName"></label>
                                        <input name="dakaFile" id="dakaFile-input" type="hidden">
                                    </div>
                                    <div class="form-group col-md-6 dakaWenduDiv">
                                        <label>体温</label>
                                        <input style="width: 450px" id="dakaWendu" name="dakaWendu" class="form-control"
                                               onchange="doubleChickValue(this)" placeholder="体温">
                                    </div>
                                    <div class="form-group col-md-6 dakaTextDiv">
                                        <label>备注</label>
                                        <textarea style="width: 450px"  id="dakaText" name="dakaText" class="form-control"placeholder="备注"></textarea>
                                    </div>
...
<script>
    ...
    function upload() {
        ...
        $('#dakaFileupload').fileupload({
            url: baseUrl + 'file/upload',
            headers: {token: window.sessionStorage.getItem("token")},
            dataType: 'json',
            done: function (e, data) {
                document.getElementById('dakaFile-input').setAttribute('value', baseUrl + 'file/download?fileName=' + data.result.file);
                document.getElementById('dakaFileName').innerHTML = "上传成功!";
            }
        });
    ...
    function getDetails() {
        ...
        if (adddaka != null && adddaka != "" && adddaka != "null") {
            ...
            $('#submitBtn').text('修改');
            if(window.sessionStorage.getItem('accountTableName') =='daka'){
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#dakaName").val(ruleForm.dakaName);
        $("#dakaWendu").val(ruleForm.dakaWendu);
        $("#dakaText").val(ruleForm.dakaText);
