            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">出入管理登记</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="yonghuId" name="yonghuId" v-model="ruleForm.yonghuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>申报理由</label>
                                        <input style="width: 450px" id="wangfanYuyueText" name="wangfanYuyueText" class="form-control"
                                               v-model="ruleForm.wangfanYuyueText" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>交通工具</label>
                                    <input style="width: 450px" id="wangfanYuyueValue" name="wangfanYuyueValue" class="form-control"
                                           v-model="ruleForm.wangfanYuyueValue" readonly>
                                </div>

                                    <div class="form-group col-md-6">
                                        <label>去哪里</label>
                                        <input style="width: 450px" id="wangfanYuyueMudidi" name="wangfanYuyueMudidi" class="form-control"
                                               v-model="ruleForm.wangfanYuyueMudidi" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="wangfanYuyueChufadi" name="wangfanYuyueChufadi" class="form-control"
                                               v-model="ruleForm.wangfanYuyueChufadi" readonly>
                                    </div>


                                    <div class="form-group col-md-6">
                                        <label>出发时间</label>
                                        <input style="width: 450px" id="wangfanYuyueChufaTime" name="wangfanYuyueChufaTime" class="form-control"
                                               v-model="ruleForm.wangfanYuyueChufaTime" readonly>
                                    </div>


                                    <div class="form-group col-md-6">
                                        <label>到达时间</label>
                                        <input style="width: 450px" id="wangfanYuyueDaodaTime" name="wangfanYuyueDaodaTime" class="form-control"
                                               v-model="ruleForm.wangfanYuyueDaodaTime" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>申报状态</label>
                                    <input style="width: 450px" id="wangfanYuyueYesnoValue" name="wangfanYuyueYesnoValue" class="form-control"
                                           v-model="ruleForm.wangfanYuyueYesnoValue" readonly>
                                </div>

                                    <div class="form-group col-md-6">
                                        <label>审核回复</label>
                                        <input style="width: 450px" id="wangfanYuyueYesnoText" name="wangfanYuyueYesnoText" class="form-control"
                                               v-model="ruleForm.wangfanYuyueYesnoText" readonly>
                                    </div>


                                    <div class="form-group col-md-6">
                                        <label>审核时间</label>
                                        <input style="width: 450px" id="wangfanYuyueShenheTime" name="wangfanYuyueShenheTime" class="form-control"
                                               v-model="ruleForm.wangfanYuyueShenheTime" readonly>
                                    </div>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "wangfanYuyue/info/" + id,
