...
<!--                                        <th>帖子内容</th>-->
    ...
    <script>
        ...
        function setDataRow(item, number) {
            ...
            else if(item.sheguanId != null){
                shenfenCell.innerHTML = '社管员';
            }
            ...
            if(false){}
                ...
                xingmingCell.innerHTML = item.sheguanName;
            }
            ...
            if(false){}
                ...
                phoneCell.innerHTML = item.sheguanPhone;
            }
            ...
            if(
                ...
                false
                    ...
                    || (window.sessionStorage.getItem('role') == "社管员" && item.sheguanId == window.sessionStorage.getItem('userId'))
                    )
            ){
                //查看列表详情
