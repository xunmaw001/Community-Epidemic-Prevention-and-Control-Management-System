...
<section class="blog-one ">
    ...
    <div @click="jump('../gonggao/detail.jsp?id='+item.id);" v-for="(item,index) in dataList" :key="index"
         class="list-item4B list-item4" style="padding: 0 3px">
        <div class="list-item-body animation-box"
             :style='{"padding":"10px","boxShadow":"0 0 0px rgba(255,0,0,.8)","margin":"0 0 10px 0","borderColor":"var(--publicSubColor)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"4px","borderStyle":"solid"}'>
            <img :style='{"boxShadow":"0 0 0px rgba(255,0,0,.8)","borderColor":"rgba(0,0,0,.3)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"130px"}'
                 :src="baseUrl+item.gonggaoPhoto">
            <div class="item-info"  style="display: flex;flex-direction: column;align-items: center;">
                <div v-if="true"
                     :style='{"isshow":true,"padding":"0","margin":"5px 0 0 0","backgroundColor":"rgba(0,0,0,0)","color":"rgba(10, 10, 10, 1)","borderRadius":"0","textAlign":"center","width":"100%","fontSize":"16px"}'
                     class="name">{{item.gonggaoName}}
                </div>
                <div v-if="item.gonggaoContent" style="overflow: hidden;display: -webkit-box;-webkit-line-clamp: 1; -webkit-box-orient: vertical;"
                     :style='{"padding":"0","margin":"10px 0 0 0","backgroundColor":"rgba(0,0,0,0)","color":"rgba(85, 85, 85, 1)","borderRadius":"0","textAlign":"center","width":"100%","fontSize":"13px"}'
                     class="time" v-html="myFilters(item.gonggaoContent)">
                </div>
                <div style="display: flex">
                    <div :style='{"padding":"0 10px","boxShadow":"0 0 6px rgba(0,0,0,.3)","margin":"20px 0 0 0","borderColor":"var(--publicSubColor)","backgroundColor":"var(--publicSubColor)","color":"rgba(255, 255, 255, 1)","borderRadius":"4px","borderWidth":"0","width":"auto","lineHeight":"18px","fontSize":"12px","text":"新闻动态","borderStyle":"solid"}' class="new9-list-item-identification">{{item.gonggaoValue}}</div>
                </div>
            </div>
        </div>
    </div>
