...
var centerMenu = [
    ...
    ,{
        name: '高风险地区记录',
        url: '../fengkong/list.jsp'
    }
    ,{
        name: '出入管理',
        url: '../wangfanYuyue/list.jsp'
    }
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/shequyiqingfangkongguanlixitong/admin/dist/index.jsp#/login";
