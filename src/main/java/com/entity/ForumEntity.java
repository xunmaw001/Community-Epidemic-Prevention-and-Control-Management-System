...
public class ForumEntity<T> implements Serializable {
     ...
     * 社管员
     */
    @ColumnInfo(comment="社管员",type="int(11)")
    @TableField(value = "sheguan_id")

    private Integer sheguanId;
    ...
    public void setSheguanId(Integer sheguanId) {
        this.sheguanId = sheguanId;
    }
    /**
	 * 获取：管理员
	 */
